...
summary(model_gammarus[["Falkestein"]])
summary(model_gammarus[["Geomar"]])
summary(model_gammarus[["Trave"]])

p1<- plot_model(model_gammarus[["Falkestein"]], terms = "Date_num",  type = "pred")
p1 <- p1 +
...
p2<- plot_model(model_gammarus[["Geomar"]], terms = "Date_num",  type = "pred", line.color = "blue")
p2 <- p2 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
...
p3<- plot_model(model_gammarus[["Trave"]], terms = "Date_num",  type = "pred")
p3 <- p3 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
  theme_bw() + xlab("Sampling months") + ylab("Total species abundance")+ ggtitle("")+ scale_y_continuous(
...
summary(model_rich[["Falkestein"]])
summary(model_rich[["Geomar"]])
summary(model_rich[["Trave"]])



p4<- plot_model(model_rich[["Falkestein"]], terms = "Date_num",  type = "pred")
p4 <- p4 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
...
p5<- plot_model(model_rich[["Geomar"]], terms = "Date_num",  type = "pred", line.color = "blue")
p5 <- p5 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
  theme_bw() + xlab("Sampling months") + ylab("Total species richness")+ ggtitle("")+ scale_y_continuous(
...
p6<- plot_model(model_rich[["Trave"]], terms = "Date_num",  type = "pred")
p6 <- p6 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
  theme_bw() + xlab("Sampling months") + ylab("Total species richness")+ ggtitle("")+ scale_y_continuous(
...
for (loc in unique(abundance_data$location)) {
  ...
  model_abun[[loc]] <- gam(Abundance ~ s(Date_num, bs = "cs", k=10) + Year, 
                               data = local_data1, 
                               family = nb())
}
summary(model_abun[["Falkestein"]])
summary(model_abun[["Geomar"]])
summary(model_abun[["Trave"]])
summary(model_abun[["Trave_alien"]])


p7<- plot_model(model_abun[["Falkestein"]], terms = "Date_num",  type = "pred")
p7 <- p7 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
...
p8<- plot_model(model_abun[["Geomar"]], terms = "Date_num",  type = "pred", line.color = "blue")
p8 <- p8 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
  theme_bw() + xlab("Sampling months") + ylab("Species abundance")+ ggtitle("")+ scale_y_continuous(
...
p9<- plot_model(model_abun[["Trave"]], terms = "Date_num",  type = "pred")
p9 <- p9 +
  scale_x_continuous(name = "Date", breaks = c(0, 27,58,92,119,155,182,216,239,279,302,329),
                     labels = c("April", "May", "June", "July", "August", "September",  "October", "November", "December", "January", "February", "March")) +
  theme_bw() + xlab("Sampling months") + ylab("Species abundance")+ ggtitle("")+ scale_y_continuous(
